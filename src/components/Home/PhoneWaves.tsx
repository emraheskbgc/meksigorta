...
export default function PhoneWaves() {
  return (
    <div className="relative flex h-[420px] w-full items-center justify-center">
      ...
      {/* İç halka */}
      <div className="phone-ring-3 absolute  h-40 w-40 md:h-60 md:w-60 rounded-full border-[3px] border-accent/40 border-dashed">
      
      </div>

      {/* Telefon */}
      <div className="relative z-10 flex flex-col items-center">
  <div className="phone-icon flex h-16 w-16 md:h-28 md:w-28 items-center justify-center rounded-full bg-accent text-white shadow-2xl">
   <a href="tel:+905305280882"><PhoneCall size={28} /></a> 
  </div>
